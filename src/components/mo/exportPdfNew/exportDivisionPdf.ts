...
//     • buildGroup4GuardMovements(item) → group 7 (disabled — will use later)
//
...
//
//   Step 4: Render guard movement detail section (disabled — will use later)
 ...
 *   6. Render guard movement detail section (disabled — will use later)
...
export async function buildDivisionPdf(
  ...
  // const group4GuardMovements = buildGroup4GuardMovements(item); // DISABLED — will use later
  ...
  // const guardItems: PdfGroupItem[] = // DISABLED — will use later
